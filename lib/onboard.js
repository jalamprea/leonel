...
function onboard (bot, message) {
  ...
  bot.startPrivateConversation({ user: user.id }, function (err, convo) {
    ...
    convo.say(
      '¡Hola! Ya que acabas de llegar por aquí te cuento unas cositas sobre nuestra comunidad: \n' +
      '• Somos una comunidad de personas interesadas en programación y diseño ' +
      'nacidas o residentes en el Quindío \n' +
    ...
    convo.say(
      ...
      'http://www.quindiotech.com/codigo-de-conducta'
    )
    convo.say('Síguenos en twitter en https://twitter.com/quindiotech')
  })
